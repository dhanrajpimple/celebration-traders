            ...
            {[
              ...
              { label: "ABOUT US", path: "/about" },
              {
                ...
                children: [
                  ...
                  { label: "Koregaon", path: "/celebration-material-koregaon" },
                  { label: "Karad", path: "/celebration-material-karad" },
                  { label: "Patan", path: "/celebration-material-patan" },
                  { label: "Khandala", path: "/celebration-material-khandala" },
                  { label: "Phalatan", path: "/celebration-material-phalatan" },
                  { label: "Shirawal", path: "/celebration-material-shirawal" },
                  { label: "Nagathane", path: "/celebration-material-nagathane" },
                ]
              },
